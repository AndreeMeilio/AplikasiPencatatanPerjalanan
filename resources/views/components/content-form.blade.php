<div class="tab-pane fade" id="form-perjalanan" role="tabpanel" aria-labelledby="nav-form-tab">
    ...
    <form class="mt-3">
        <div class="mb-3" id="form_perjalanan_tanggal">
        ...
        <div class="mb-3" id="form_perjalanan_waktu">
        ...
        <div class="mb-3" id="form_perjalanan_suhu">
        ...
        <div class="mb-3" id="form_perjalanan_lokasi">
